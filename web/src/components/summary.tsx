    ...
    <div className="py-10 max-w-[480px] px-5 mx-auto flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <div className=" flex items-center gap-3">
          <InOrbitIcon/>
          <span className="text-zinc-50 font-semibold">05 a 12 de Agosto</span>
        </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className=" flex flex-col gap-3">
              <li className="flex items-center gap-2">
                ...
                <span className="text-zinc-400 text-sm">Você completou “<span className="text-zinc-100">Acordar cedo</span>” às <span className="text-zinc-100">08:13h</span></span>
              </li>
            </ul>
